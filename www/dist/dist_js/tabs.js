(function(){
  ...
  .controller('DashCtrl', ['$scope', 'brainDareService', '$state', 'Auth', 'firebaseData', function($scope,brainDareService, $state, Auth, firebaseData) {
  ...
  .controller('AccountCtrl', ['$scope', '$state', 'Auth', '$rootScope', '$ionicUser', '$ionicPush', function($scope, $state, Auth, $rootScope, $ionicUser, $ionicPush) {
