(function(){
  ...
  .controller('DashCtrl', ['$scope', 'brainDareService', '$state', 'Auth', 'firebaseData', 'ionicMaterialInk', 'ionicMaterialMotion', 'quotes', function($scope,brainDareService, $state, Auth, firebaseData, ionicMaterialInk, ionicMaterialMotion, quotes) {
    this.downArrow = true;
  ...
  .controller('DareCtrl', ['$scope', 'brainDareService', function($scope, brainDareService){
  ...
  .controller('AccountCtrl', ['$scope', '$state', 'Auth', '$rootScope', '$ionicUser', '$ionicPush', 'quotes', '$cordovaLocalNotification', function($scope, $state, Auth, $rootScope, $ionicUser, $ionicPush, quotes, $cordovaLocalNotification) {
  ...
  .service('quotes', ['$http', function($http){
    var quote = {};
